...
const [timeLeft, setTimeLeft] = useState({});
 ...
 const products = [
  ...
  { id: 420, title: "Fresh Orange Juice", description: "100% freshly squeezed oranges, rich in Vitamin C and natural sweetness. Perfect immunity booster.", price: 90, offerPrice: 82,  rating: 4.9, reviewCount: 820, image: "/drinks/orange-juice.png", inStock: true },
  { id: 203, title: "Double Toned Milk", description: "Low-fat double toned milk, great for fitness-conscious individuals. Keeps you light while maintaining nutrition.", price: 45, offerPrice: 37,  rating: 4.4, reviewCount: 390, image: "/milk/double-toned.webp", inStock: true },
  ...
  { id: 308, title: "Cough Syrup", description: "Relieves both dry and wet cough, soothes throat irritation, and provides quick comfort for respiratory issues.", price: 90, offerPrice: 83, rating: 4.5, reviewCount: 640, image: "/medicines/cough-syrup.webp", inStock: true },
  { id: 512, title: "Murukku", description: "Traditional South Indian crispy spiral snack made from rice flour and spices. Crunchy, savory, and addictive.", price: 140, offerPrice: 133, rating: 4.7, reviewCount: 950, image: "/treats/murukku.webp", inStock: true },
...
{ id: 413, title: "Monster Energy", description: "High-performance energy drink with a bold flavor and extra caffeine boost. Popular among gamers and athletes.", price: 130, offerPrice: 123, rating: 4.6, reviewCount: 2200, image: "/drinks/monster.jpg", inStock: true },
{ id: 206, title: "Buffalo Milk", description: "Thick and creamy buffalo milk, rich in calcium and flavor. Best for making curd, paneer, and sweets.", price: 65, offerPrice: 58, rating: 4.5, reviewCount: 350, image: "/milk/buffalo-milk.webp", inStock: true },
...
{ id: 303, title: "Amoxicillin", description: "A powerful antibiotic used to treat bacterial infections like throat infection, pneumonia, and ear infections. Always use under prescription.", price: 120, offerPrice: 110, rating: 4.5, reviewCount: 560, image: "/medicines/amoxicillin.png", inStock: true },
{ id: 501, title: "Rasgulla", description: "Delicate and spongy cottage cheese balls soaked in light sugar syrup. A melt-in-mouth treat that is light, refreshing, and perfect after meals.", price: 110, offerPrice: 103, rating: 4.8, reviewCount: 980, image: "/treats/rasagulla.webp", inStock: true },
];
